package com.azhuoinfo.gbf.view.gallery;
 ...
 * <p>
 * Views given to the Gallery should use {@link LeftGallery.LayoutParams} as their
 ...
 * CHECKSTYLE:ON
 */
public final class LeftGallery extends AbsSpinner implements GestureDetector.OnGestureListener {
     ...
     */
    public LeftGallery(final Context context) {
        this(context, null);
    }
     ...
     */
    public LeftGallery(final Context context, final AttributeSet attrs) {
    ...
    protected LayoutParams generateDefaultLayoutParams() {
         ...
         */
        return new LeftGallery.LayoutParams(LayoutParams.WRAP_CONTENT,
