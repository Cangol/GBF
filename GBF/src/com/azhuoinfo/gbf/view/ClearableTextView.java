...
public class ClearableTextView extends TextView {
    ...
    final Drawable imgX = getResources().getDrawable(R.drawable.ic_clear);// X image //android.R.drawable.presence_offline 
    ...
    void init()  {
        ...
        this.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                ClearableTextView et = ClearableTextView.this;
