...
public class AccountVerify {
	...
	public void showLoginDialog(final BaseFragment fragment) {
		...
		.setLeftButtonInfo(fragment.getString(R.string.common_dialog_confirm), new OnButtonClickListener() {
		...
		}).setRightButtonInfo(fragment.getString(R.string.common_dialog_cancel), new OnButtonClickListener() {
			@Override
			public void onClick(View view) {
				// do nothing
			}
